...
class SalesApp(SearchableAppWindow):
    ...
    def create_actions(self):
        ...
        actions = [
            ...
            ("SalesGenerateNFePreview", None, u"Pré Visualização do DANFE"),
    ...
    def get_columns(self):
        ...
        cols = [SearchColumn('id', title=_('#'), width=80,
                ...
                SearchColumn('invoice_number', title=_(u'Nota nº'), width=80,
                             format='%05d', data_type=int, editable=True, spin_adjustment=adj),
                SearchColumn('nfe_invoice', title=_(u'NFe nº'), width=80,
                             data_type=int),
                SearchColumn('nfce_invoice', title=_(u'NFCe nº'), width=80,
                             data_type=int),
