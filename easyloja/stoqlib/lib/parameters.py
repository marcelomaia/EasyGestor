...
class ParameterDetails(object):
    def __init__(self, key, group, short_desc, long_desc, type,
                 ...
                 multiline=False, validator=None, onupgrade=None, mask='', editor=None):
        """
    ...
    def validate_printer_name(printer_name):
        if ' ' in printer_name:
            return ValidationError("O nome da impressora não deve possuir espaços.")
...
_details = [
    ...
    # THESE BELOW WHERE MADE AT EBI
    # CHECK bin/new_param.py
    # LEONAM -> leohenryster@gmail.com

    ParameterDetails(
        'EMPLOYERS_CAN_REMOVE_ITEMS',
        _('Sales'),
        _('Remover Items no PDV'),
        _('Quando Ativado e possviel remover items em uma venda no PDV'),
        bool, initial=False),

    ParameterDetails(
        'TIME_TO_EMIT_Z',
        _('Sales'),
        _('Horario da Redução Z'),
        _('Apartir de qual Horario se pode emitir uma reduzão Z'),
        str, initial=None, mask='00:00'),

    ParameterDetails(
        'CHOISE_BRANCH_NFE',
        _('Sales'),
        _('Escolher Filial Para NFE'),
        _('Ao Gerar uma Nota Eletronica é possivel escolher a filial'),
        bool, initial=True),

    # MARCELO -> mmaia.cc@gmail.com
    ParameterDetails(
        'PROMOTIONAL_MESSAGE',
        _('Sales'),
        _('Mensagem promocional'),
        _('Ao gerar um cupom fiscal, é possivel adicionar uma mensagem promocional'),
        str, initial='Edite-me'),

    ParameterDetails(
        'ITEMS_TO_TAB',
        _('Sales'),
        _('Comanda'),
        _('Para adicionar obervações nos items de uma venda, ex: mal passado, bem passado. '
          'Estas devem estar separadas por ponto e vírgula (;)'),
        str, initial='Edite-me'),

    ParameterDetails(
        'DEFAULT_SUBJECT_RECURRENCY',
        _('Purchase'),
        _('Assunto de Email'),
        _('O e-mail de recorrencia dos produtos deve conter um assunto, na ausencia de um este será usado'),
        str, initial=''),
    ...
    ParameterDetails(
        'CUSTOM_LOGO_FOR_NFCE',
        _('General'),
        _('Logo personalizado para NFCe'),
        _('Defines a custom logo for all the reports generated by Stoq. '
          'The recommended image dimension is 171x59 (pixels), if needed, '
          'the image will be resized. In order to use the default logotype '
          'leave this field blank'), ImageHelper, initial=''),
    ...
    ParameterDetails(
        'NFE_PARTNER_KEY',
        _('NFe'),
        _('Chave de parceiro NFe/NFCe'),
        _('Define a chave de parceiro para a emissão de NFe/NFCe. '
          'A chave é obtida no site: http://app.invoicy.com.br/'), unicode,
        initial='3bJTEtXKouFKuy04sRVv2w=='),

    ParameterDetails(
        'CAN_CHANGE_NFCE_STATUS',
        _('NFCe'),
        _('(ATENÇÃO) Para uso do suporte somente'),
        _('Permite trocar o a situação da NFCe'), bool, initial=False,
        options={1: _('Sim'),
                 0: _('Não')}),
    ...
    ParameterDetails(
        'RESTAURANT_MODE',
        _('Restaurante'),
        _('Modo restaurante (BETA)'),
        _('Habilita o modo restaurante, incialmente serve pera imprimir comandas '
          'por impressora não fiscal.'), bool, initial=False,
        options={1: _('Ativo'),
                 0: _('Inativo')}),
    ...
    ParameterDetails(
        ...
        _('Sales'),
        'Modo preço dinâmico',
        'No Ponto de Vendas permite alterar o preço do produto e quantidade mesmo após o produto'
        'ter sido adicionado.',
        bool, initial=False, options={1: _('Ativo'),
                                      0: _('Inativo')}),

    ParameterDetails(
        'CATEGORY_PRICE',
        _('Sales'),
        'Modo de categorias de preços (VAREJO/ATACADO/ETC)',
        'Muda o preço do produto no Ponto de Vendas, item a item',
        bool, initial=False, options={1: _('Ativo'),
                                      0: _('Inativo')}),
    ...
    ParameterDetails(
        'POS_COLOR',
        _('Sales'),
        'Cor do Plano de fundo do Ponto de Vendas',
        'Escolha uma cor no formato hexadecimal para o seu PDV! '
        'Recomendamos o '
        '\nhttp://www.w3schools.com/colors/colors_picker.asp, \n'
        'para buscar sua cor favorita',
        str, initial='#ff6600', editor='color-button'),

    ParameterDetails(
        'CHOSE_SALE_CONFIRM_DATE',
        _('Sales'),
        'Escolher data de confirmação de pagamentos (BETA)',
        'No fechamento de uma venda um assistente permite que o usuário altere a data de '
        'confirmação de um pagamento de uma venda',
        bool,
        initial=False),
    ...
    ParameterDetails(
        ...
        _('NFCe'),
        'Modo seguro NFCe',
        'Habilita senha de administrador para funcionalidades restritas NFCe',
        bool,
        initial=False),
    ...
    ParameterDetails(
        'CUSTOM_LOGO_FOR_POS',
        _('General'),
        'Logotipo customizado para o PDV',
        _('Defines a custom logo for all the reports generated by Stoq. '
          'The recommended image dimension is 171x59 (pixels), if needed, '
          'the image will be resized. In order to use the default logotype '
          'leave this field blank'), ImageHelper, initial=''),
    ...
    ParameterDetails(
        ...
        'Gestão de boletos com a plataforma iugu, verifique o seu id em '
        'https://app.iugu.com/account',
        str, initial=''),

    ParameterDetails(
        'CSC_CODE',
        _('NFCe'),
        'O CSC - Código de Segurança do Contribuinte é um código de segurança alfanumérico',
        ' de conhecimento apenas da SEFA e do contribuinte (sócio), utilizado para gerar '
        'o código bidimensional, denominado "QR Code" da NFC-e.',
        str, initial=''),

    ParameterDetails(
        'NFCE_AMB',
        _('NFCe'),
        'Tipo de ambiente NFCe',
        '1=Produção\n'
        '2=Homologação\n',
        int, initial=1, options={1: _('Produção'),
                                 2: _('Homologação')}),
    ParameterDetails(
        'NFE_AMB',
        _('NFe'),
    ...
    ParameterDetails(
        ...
        _('General'),
        _('Auto completar'),
        _('Desabilite caso for usar leitor de código de barras no PDV'),
        bool, initial=True),

    ParameterDetails(
        'COMPLETE_REGISTER_INDIVIDUAL',
        _('General'),
        _('Cadastro completo P.F.'),
        _('Só permite criar uma venda/cotação se o cadastro do cliente tiver com CPF'),
        bool, initial=False),

    ParameterDetails(
        'COMPLETE_REGISTER_COMPANY',
        _('General'),
        _('Cadastro completo P.J.'),
        _('Só permite criar uma venda/cotação se o cadastro do cliente tiver com CNPJ'),
        bool, initial=False),

    ParameterDetails(
        'CAN_CHANGE_OPEN_DATE',
        _('General'),
        _('Mudar a data de abertura do pagamento'),
        _('No contas a pagar ou receber, permite mudar a data de abertura'),
        bool, initial=False),

    ParameterDetails(
        'CAN_CHANGE_PRICE_IN_QUOTE',
        _('Sales'),
        _('Mudar preço dos itens na cotação'),
...
class ParameterAccess(ClassInittableObject):
    ...
    def _create_tax_service(self):
        from stoqlib.domain.service import Service
        key = "TAX_SERVICE"
        if self.get_parameter_by_field(key, Service):
            return

        self.create_tax_service()
