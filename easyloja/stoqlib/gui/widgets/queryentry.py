...
from stoqlib.domain.person import PersonAdaptToClient, ClientView, PersonAdaptToSupplier, SupplierView
...
class QueryEntryGadget(object):
    ...
    def __init__(self, entry, store, initial_value=None,
        ...
        self._executer = ORMObjectQueryExecuter(self.store)
...
class ClientEntryGadget(PersonEntryGadget):
    ...
    person_type = PersonAdaptToClient
    search_class = ClientSearch
    search_spec = ClientView
    search_columns = [ClientView.q.name, ClientView.fancy_name,
...
class SupplierEntryGadget(PersonEntryGadget):
    ...
    person_type = PersonAdaptToSupplier
