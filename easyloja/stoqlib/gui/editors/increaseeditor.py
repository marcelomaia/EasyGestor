...
from stoqlib.domain.stockincrease import StockIncreaseItem
...
class IncreaseItemEditor(PurchaseItemEditor):
    model_type = StockIncreaseItem
    model_name = _("Increase Item")
    ...
    def on_quantity__validate(self, widget, value):
        ...
        branch = self.model.stock_increase.branch
