...
class FormFieldEditor(BasicDialog):
    ...
    def _get_columns(self):
        return [Column('description', title=u'Descrição', data_type=str,
                       expand=True, sorted=True),
                Column('visible', title=u'Visível', data_type=bool,
                       width=120, editable=True),
                Column('mandatory', title=u'Obrigatório', data_type=bool,
                       width=120, editable=True)]
