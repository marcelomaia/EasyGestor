...
# added at EBI
STOQ_FISCAL_PRINTER = "stoq-fiscal-printer"
STOQ_DOLLAR = "stoq-dollar"
STOQ_CHECKLIST = 'stoq-checklist'
STOQ_PLUG = 'stoq-plug'
STOQ_BRANCH = 'branch'
STOQ_TOOL = 'tool'
STOQ_EVENTS = 'stoq-events'
STOQ_CFOP = 'stoq-cfop'
STOQ_PAYMENT_CATEGORY = 'stoq-payment-category'
STOQ_EASY_LOJA = 'stoq-easy-loja'
STOQ_BACKUP = "stoq-backup"
STOQ_CONTRACTS = 'stoq-contracts'
STOQ_NFCE = "stoq-nfce"
STOQ_PERCENT = "stoq-percent"
STOQ_BARCODE = "stoq-barcode"
...
icon_info = [
    ...
    (STOQ_CALENDAR_APP,
     {GTK_ICON_SIZE_LARGE_TOOLBAR: "stoq-calendar-24x24.png",
      GTK_ICON_SIZE_DIALOG: "stoq-calendar-48x48.png"}),
    (STOQ_CALENDAR_LIST,
    ...
    (STOQ_KEYBOARD,
     {GTK_ICON_SIZE_DIALOG: "stoq-keyboard-48x48.png"}),
    (STOQ_MONEY,
    ...
    (STOQ_FISCAL_PRINTER,
     {GTK_ICON_SIZE_DIALOG: "fiscalprinter48x48.png"}),
    (STOQ_DOLLAR,
     {GTK_ICON_SIZE_DIALOG: "dollar48x48.png"}),
    (STOQ_CHECKLIST,
     {GTK_ICON_SIZE_DIALOG: "checklist48x48.png"}),
    (STOQ_PLUG,
     {GTK_ICON_SIZE_DIALOG: "plug48x48.png"}),
    (STOQ_BRANCH,
     {GTK_ICON_SIZE_DIALOG: "branch48x48.png"}),
    (STOQ_TOOL,
     {GTK_ICON_SIZE_DIALOG: "tool48x48.png"}),
    (STOQ_EVENTS,
     {GTK_ICON_SIZE_DIALOG: "events48x48.png"}),
    (STOQ_CONTRACTS,
     {GTK_ICON_SIZE_DIALOG: "receive_order48px.png"}),
    (STOQ_NFCE,
     {GTK_ICON_SIZE_DIALOG: "NFCe.png"}),
    (STOQ_PERCENT,
     {GTK_ICON_SIZE_DIALOG: "percent.png"}),
    (STOQ_CFOP,
     {GTK_ICON_SIZE_DIALOG: "cfop48x48.png"}),
    (STOQ_PAYMENT_CATEGORY,
     {GTK_ICON_SIZE_DIALOG: "payment_category48x48.png"}),
    (STOQ_EASY_LOJA,
     {GTK_ICON_SIZE_MENU: "easyloja16x16.png",
      GTK_ICON_SIZE_LARGE_TOOLBAR: "easyloja32x32.png",
      GTK_ICON_SIZE_DND: "easyloja32x32.png",
      GTK_ICON_SIZE_DIALOG: "easyloja64x64.png"}),
    (STOQ_BACKUP, {GTK_ICON_SIZE_MENU: "stoq-backup.png",
                   GTK_ICON_SIZE_DIALOG: "stoq-backup.png"}),
    (STOQ_BARCODE,
     {GTK_ICON_SIZE_DIALOG: "barcode.png"}),
    (STOQ_QUANTITY,
     {GTK_ICON_SIZE_DIALOG: "quantity.png"}),
    (STOQ_COLOR_PALETE,
