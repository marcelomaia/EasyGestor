...
class BaseWizard(PluggableWizard, RunnableView):
    ...
    def __init__(self, conn, first_step, model=None, title=None,
        ...
        change_button_appearance(self.next_button, gtk.STOCK_GO_FORWARD, 'Seguir')
        change_button_appearance(self.previous_button, gtk.STOCK_GO_BACK, 'Voltar')
        change_button_appearance(self.cancel_button, gtk.STOCK_CANCEL, 'Cancelar')
