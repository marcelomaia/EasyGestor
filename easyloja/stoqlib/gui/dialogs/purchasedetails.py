...
class _TemporaryReceivingDetails:
    ...
    def __init__(self, orders):
        freight_type_map = {
            ...
            ReceivingOrder.FREIGHT_FOB_FIRST_INSTALLMENT: PurchaseOrder.FREIGHT_FOB,
        }
        ...
        if orders.count():
            ...
            self.nfe_key = order.nfe_key
            self.invoice_number = order.invoice_number
            self.invoice_serie = order.invoice_serie
...
class PurchaseDetailsDialog(BaseEditor):
    ...
    def _get_ordered_columns(self):
        return [Column('description',
                ...
                Column('ipi', title=_('IPI'), data_type=currency,
    ...
    def _export_csv(self):
        run_dialog(CSVExporterDialog, get_current_toplevel(), None, PurchaseItemView,
                   self.ordered_items)
