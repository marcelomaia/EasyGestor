...
_bindings = [
    ...
    ('app.payable.payment_renegotiate', '',
     _("Renegotiate the selected payment")),

    # tab application
    ('app.sales.till_open', '<Control>F6',
     _("Open the till")),
    ('app.sales.till_close', '<Control>F7',
     _("Close the till")),
    ...
    ('app.pos.item_edit', '<Control>e',
     _("Edita item da venda")),
    ('app.pos.item_remove', '<Control>Delete',
     _("Edita item da venda")),
