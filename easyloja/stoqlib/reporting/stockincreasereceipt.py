...
""" A Manual stock increase receipt implementation """
...
class StockIncreaseReceipt(BaseStoqReport):
    """Stock Increase receipt
        This class builds the namespace used in template
    """
    report_name = _("Manual Stock Increase Receipt")
    ...
    def _identify_removed_by(self):
        ...
        employee = self.order.added_by.person
        ...
        data = [
            ...
            [_(u'Responsible:'), user.name, _(u'Added By:'), employee.name],
        ]
    ...
    def _add_signatures(self):
        self.add_signatures([_(u"Responsible"), _(u'Added By:')])

    def get_title(self):
        return _(u'Number: %s - Manual stock increase on %s') % (
