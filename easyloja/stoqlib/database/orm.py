...
from sqlobject.sqlbuilder import (AND, Alias, IN, INNERJOINOn, ISNULL, ISNOTNULL, JOIN,
                                  LEFTJOINOn, LIKE, OR, Update, Field, STARTSWITH, CONTAINSSTRING,
                                  NoDefault, const, sqlIdentifier, DESC, func, NOT)
...
ORMObjectMoreThanOneResultError = SQLObjectNotFound
