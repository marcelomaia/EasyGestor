...
from stoqlib.gui.wizards.nfewizard import NFeProductBatchWizard
...
class PurchaseApp(SearchableAppWindow):
    ...
    def create_actions(self):
        ...
        actions = [
            ...
            ("NewBatchProduct", None, _("Produtos em lote..."),
             group.get('new_product'),
             _("Criar novos produtos em lote")),
            ...
            ("Services", None, _("Serviços e históricos..."),
    ...
    def get_columns(self):
        return [SearchColumn('id', title=_('#'),
                ...
                SearchColumn('invoice_number', title=_('Nro. NFe'),
                             data_type=int),
                SearchColumn('invoice_serie', title=_(u'Série'),
                             data_type=int),
                SearchColumn('nfe_key', title=_('Chave NFe'),
                             data_type=str)]
    ...
    def on_NewBatchProduct__activate(self, action):
        run_dialog(NFeProductBatchWizard, get_current_toplevel(), self.conn)
