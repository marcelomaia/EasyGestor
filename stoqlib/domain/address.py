...
class Address(Domain):
    ...
    def get_address_string(self):
        ...
        if self.street and self.streetnumber and self.district:
            address_string = u'%s %s, %s' % (self.street, self.streetnumber,
                                             self.district)
        elif self.street and self.district:
            address_string = u'%s %s, %s' % (self.street, _(u'N/A'), self.district)
        elif self.street and self.streetnumber:
            address_string = u'%s %s' % (self.street, self.streetnumber)
        elif self.street:
            address_string = self.street
        if self.complement:
            complement = u"\nComplemento: {}".format(self.complement)
