...
from stoqlib.gui.base.dialogs import run_dialog, get_dialog, BasicDialog, get_current_toplevel
...
class ModelListSlave(ListSlave):
    ...
    def __init__(self, columns=None, conn=None,
        ...
        self.listcontainer.add_button.set_label('Adicionar')
        self.listcontainer.edit_button.set_label('Editar')
        self.listcontainer.remove_button.set_label('Remover')

        image = gtk.Image()
        image.set_from_stock(gtk.STOCK_ADD, gtk.ICON_SIZE_LARGE_TOOLBAR)
        image.show()
        self.listcontainer.add_button.set_image(image)

        image = gtk.Image()
        image.set_from_stock(gtk.STOCK_EDIT, gtk.ICON_SIZE_LARGE_TOOLBAR)
        image.show()
        self.listcontainer.edit_button.set_image(image)

        image = gtk.Image()
        image.set_from_stock(gtk.STOCK_REMOVE, gtk.ICON_SIZE_LARGE_TOOLBAR)
        image.show()
        self.listcontainer.remove_button.set_image(image)
    ...
    def run_dialog(self, dialog_class, *args, **kwargs):
        ...
        retval = run_dialog(dialog, get_current_toplevel())
        if not retval:
...
class ModelListDialog(gtk.Dialog, ModelListSlave):
    ...
    def __init__(self, conn=None):
        ...
        image = gtk.Image()
        image.set_from_stock(gtk.STOCK_CLOSE, gtk.ICON_SIZE_LARGE_TOOLBAR)
        image.show()
        close_bt = self.add_button(gtk.STOCK_CLOSE, gtk.RESPONSE_CLOSE)
        close_bt.set_label('Fechar')
        close_bt.set_image(image)
...
class AdditionListSlave(StoqlibSearchSlaveDelegate):
    ...
    def add_extra_button(self, label=None, stock=None):
        ...
        self.hbuttonbox1.pack_end(button, False, False)
        button.show()
