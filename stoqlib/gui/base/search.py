...
from stoqlib.gui.base.gtkadds import button_set_image_with_label, change_button_appearance
...
class SearchDialog(BasicDialog):
    ...
    def _setup_details_slave(self):
        ...
        change_button_appearance(self._details_slave.print_button, gtk.STOCK_PRINT, 'Imprimir')
        change_button_appearance(self._details_slave.details_button, gtk.STOCK_FIND, 'Detalhes')
