...
from stoqlib.domain.person import AffiliateView, PersonAdaptToAffiliate
...
class PaymentAffiliateBillsDialog(BaseEditor):
    gladefile = 'PaymentAffiliateFlowHistoryDialog'
    title = u'Busca de boletos de afiliados'
    # size = (600, 200)
    model_type = Settable
    ...
    def on_confirm(self):
        ...
        return Settable(start_date=datetime.datetime(year=start_date.year,
                        ...
                        end_date=datetime.datetime(year=end_date.year,
                                                   ...
                                                   hour=23,
                                                   minute=59),
                        affiliate=self.affiliate.read())


class DaySelectDialogDialog(BaseEditor):
    gladefile = 'PaymentFlowHistoryDialog'
    title = u'Selecione um dia'
    # size = (600, 200)
    model_type = Settable
