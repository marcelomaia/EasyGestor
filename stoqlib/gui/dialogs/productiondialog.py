...
from stoqlib.gui.base.dialogs import BasicWrappingDialog, run_dialog, get_current_toplevel
...
class ProductionComponentSlave(GladeSlaveDelegate):
    ...
    def _run_csv_exporter_dialog(self):
        run_dialog(CSVExporterDialog, get_current_toplevel(), None,
...
class ProductionDialog(GladeSlaveDelegate):
    ...
    def validate_confirm(self):
        ...
        retval = run_dialog(PurchaseWizard, get_current_toplevel(), trans, order)
