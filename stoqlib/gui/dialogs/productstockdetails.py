...
class ProductStockHistoryDialog(BaseEditor):
    ...
    def _setup_widgets(self):
        ...
        self.increase_list.set_columns(self._get_increase_columns())
        ...
        items = StockIncreaseItemsView.select(
            StockIncreaseItemsView.q.sellable == self.model.id,
            connection=self.conn)

        self.increase_list.add_list(list(items))
    ...
    def _get_sale_columns(self):
        return [Column("sale_id", title=_("#"),
                ...
                Column("sale_price", title=_("Price"), data_type=currency),
                Column("quantity", title=_("Sold"), data_type=int),
                Column("total", title=_("Total"), data_type=currency),
    ...
    def _get_transfer_columns(self):
        return [Column("transfer_order.id", title=_("#"),
                ...
                Column("transfer_order.source_responsible_name",
                       title=_("Resp. orig"), expand=True,
                       data_type=str),
                Column("transfer_order.destination_responsible_name",
                       title=_("Resp. dest"), expand=True,
                       data_type=str),
    ...
    def _get_increase_columns(self):
        return [Column("id", title=_("#"), data_type=int,
                       justify=gtk.JUSTIFY_RIGHT, sorted=True),
                Column("date", title=_("Date"), data_type=datetime.date,
                       justify=gtk.JUSTIFY_RIGHT),
                Column("added_by_name", title=_("Added By:"), expand=True,
                       data_type=str),
                Column("quantity", title=_("Quantity"), data_type=int),
                Column("unit_description", title=_("Unit"), data_type=str)]
