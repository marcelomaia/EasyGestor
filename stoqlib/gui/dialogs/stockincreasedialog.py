...
class StockIncreaseDetailsDialog(BaseEditor):
    title = _(u"Manual Stock Increase Details")
    hide_footer = True
    size = (700, 400)
    model_type = StockIncrease
    gladefile = "StockIncreaseDetails"
    ...
    def _setup_widgets(self):
        ...
        products = StockIncreaseItem.selectBy(stock_increase=self.model,
