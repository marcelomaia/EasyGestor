...
class CSVExporterDialog(BaseEditor):
    ...
    def _setup_widgets(self):
        change_button_appearance(self.main_dialog.ok_button, gtk.STOCK_SAVE_AS, 'Salvar como')
    ...
    def _get_csv_content(self, encoding):
        if isinstance(self.model.results, ObjectList):
            objlst = objectlist2csv(self.model.results, encoding)
            return objlst
