...
from stoqlib.domain.taxes import (SaleItemIcms, ProductIcmsTemplate,
                                  SaleItemIpi, ProductIpiTemplate, ProductPisTemplate, ProductCofinsTemplate,
                                  SaleItemCofins, SaleItemPis)
...
class PISTemplateSlave(BasePISSlave):
    ...
    hide_widgets = BasePISSlave.value_widgets
...
class COFINSTemplateSlave(BaseCOFINSSlave):
    ...
    hide_widgets = BaseCOFINSSlave.value_widgets
...
class SaleItemCOFINSSlave(BaseCOFINSSlave):
    model_type = SaleItemCofins
...
class SaleItemPISSlave(BasePISSlave):
    model_type = SaleItemPis
